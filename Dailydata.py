...
csv_export = df2.to_csv(sep=",", quoting=QUOTE_ALL, quotechar='"', columns=['date', 'customer_id', 'sold_qty', 'scan_qty','temperature_celsius','temperature_farenheit','Holiday','nearbyevent','Day of the week','Promotion'])
print("\n CSV data:", csv_export)

df2.to_csv(f"exportdaily.csv",
                  columns=['date', 'customer_id', 'sold_qty', 'scan_qty','temperature_celsius','temperature_farenheit','Holiday','nearbyevent','Day of the week','Promotion'],
